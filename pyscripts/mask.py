...
PROTECT_KEYS = [
    ...
    "os_password", "readonly_user_password", "secret_key", "tls\\.(key|crt)",
    "telemetry_secret", "metering_secret", "backup_tsm_password",
    "chap_password", "nas_password", "cisco_fc_fabric_password",
    "coraid_password", "eqlx_chap_password", "fc_fabric_password",
    "hitachi_auth_password", "hitachi_horcm_password", "hp3par_password",
    "hplefthand_password", "netapp_password", "netapp_sa_password",
    "nexenta_password", "san_password", "vmware_host_password",
    "zadara_password", "zfssa_initiator_password", "hmac_keys",
    "zfssa_target_password", "os_privileged_user_password",
